...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2026 at 05:39 AM
...
(13, 2, '1001', 'CASH', 1000.00, 0.00, 'TTEST', 'TES', 'ADMIN-KYLE', '2026-03-27 21:07:05'),
(14, 2, '2001', 'TEST', 0.00, 1000.00, 'TES', 'TEST', 'ADMIN-KYLE', '2026-03-27 21:07:05'),
...
--
ALTER TABLE `tbl_journal`
  MODIFY `journal_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_journal_details`
--
ALTER TABLE `tbl_journal_details`
  MODIFY `details_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tbl_loans_payment`
  MODIFY `payment_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
